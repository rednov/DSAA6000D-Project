...
class kgc(torch.nn.Module):
    ...
    def __init__(self, num_entities, num_relations, num_edges, params):
        ...
        self.conv1 = kgcConv(params.gcn_in_dim, params.gcn_out_dim, num_relations * 2)
